...
void MODS_ReciveNew(uint8_t _byte)
{
	...
	*/
	...
	if(ModelBaud==0)       //2400
		timeout = 14000;
	else if(ModelBaud==1)  //4800
		timeout = 7200;
  else if(ModelBaud==2)  //9600
		timeout = 3500;
	else if(ModelBaud==3)  //19200
		timeout = 1600;
	else if(ModelBaud==4)  //38400
		timeout = 1000;
  else if(ModelBaud==5)  //57600
		timeout = 500;
	else if(ModelBaud==6)  //115200
		timeout = 250;
