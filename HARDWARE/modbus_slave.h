...
#define SLAVE_REG_P210		0x0210
#define SLAVE_REG_P211		0x0211
#define SLAVE_REG_P212		0x0212
#define SLAVE_REG_P213		0x0213
#define SLAVE_REG_P214		0x0214
#define SLAVE_REG_P215		0x0215
/* 04H 读取输入寄存器(模拟信号) */
